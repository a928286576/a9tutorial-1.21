package com.a928286576.studymod.event;
...
@EventBusSubscriber(modid = StudyMod.MOD_ID, bus = EventBusSubscriber.Bus.GAME)
public class ModEvents {
    private static final Set<BlockPos> HARVESTED_BLOCKS = new HashSet<>();

    @SubscribeEvent
    public static void onHummerUsage(BlockEvent.BreakEvent event) {
